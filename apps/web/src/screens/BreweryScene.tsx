...
const EQUIP_DEFS: Record<string, EquipDef> = {
  ...
  mash_tun:         { name: 'Заторный бак',     unlockLevel: 4, buyPrice: 400,  maxLevel: 2, upgradePrices: [700],        upgradeLevelReq: [5],    descriptions: ['Заторный бак 80 л','Бак 150 л'],                   bonuses: ['+5% экстракт','+12% экстракт'],                      sceneX: 200, sceneW: 50, drawHeight: 60 },
  hop_back:         { name: 'Хмелевой бак',     unlockLevel: 6, buyPrice: 600,  maxLevel: 2, upgradePrices: [1000],       upgradeLevelReq: [7],    descriptions: ['Хмелевой бак','Бак с фильтром'],                   bonuses: ['+5% IBU точн.','+10% IBU точн.'],                    sceneX: 265, sceneW: 40, drawHeight: 55 },
  conditioning_tank:{ name: 'Чан выдержки',     unlockLevel: 9, buyPrice: 700,  maxLevel: 2, upgradePrices: [1200],       upgradeLevelReq: [9],    descriptions: ['Чан 100 л','Охлаждаемый 200 л'],                   bonuses: ['-15% время','-30% время'],                           sceneX: 316, sceneW: 48, drawHeight: 65 },
}
